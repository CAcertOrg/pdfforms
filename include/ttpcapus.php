...
define('TEXT_6A','I have read and agree to the CAcert Community Agreement (CCA). (http://www.cacert.org/policy/CAcertCommunityAgreement.php)');
...
define('TEXT_AT3',"Check if the presented names match the names in the ID documents. As the Practice on Names policy allows to have less given names stated the application form then in the ID documents. Abbreviation of given names are also allowed as long as at least on given name is given in full length. (see: http://wiki.cacert.org/PracticeOnNames) \nIf the names differ from the ones in the ID documents please copy all names on the backside of TTPCAP form.");
...
define('TEXT_AT16','Complete the Notarial statement and if applicable inster the affidavit number.');

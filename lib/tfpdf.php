...
var $DisplayPreferences=''; //extended by me

var $href="";
var $pre="";
var $anchor="";
var $list=""; //string for the list element
var $liststart=""; //duplicated starts
var $listend=""; //duplicated end
var $htmlnumber;
var $htmlnumberlevel;
var $htmlnumberi=array();
var $htmlnumbertype=array();
var $htmltitle="";
var $htmlwidth;
var $pdftype="";
...
function AddFont($family, $style='', $file='', $uni=false)
{
  ...
  //added by inopiae	   
  if (strpos($this->fontpath,'font')===false){
                $this->fontpath = 'font/';
                }
...
function _loadfont($font)
{
	...
	$a = get_defined_vars();
	if(!isset($a['name']))
		$this->Error('Could not include font definition file'.'  _'.$this->fontpath.$font);
	return $a;
}
